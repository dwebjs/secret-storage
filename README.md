# @dwebjs/secret-storage
JavaScript implementation for storing dWeb 2.0-based keys in the root of a [@dwebjs/ddrive](https://github.com/dwebjs/ddrive) directory.
